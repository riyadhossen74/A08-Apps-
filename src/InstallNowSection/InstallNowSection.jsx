...
const InstallNowSection = () => {
    ...
    const {image, title, downloads, ratingAvg, size, companyName, totalReviews, description} = product || {}
    console.log( id)
    console.log(product)
       ...
       <div className='bg-[#F5F5F5]'>
         <div className='flex container mx-auto gap-20 py-10'>
           ...
           <div className='border-b border-gray-300 py-3'>
            ...
            <span className='text-gray-500 '>Developed by: <a className='text-[#9F62F2] ' href=''>{companyName}</a></span>
           </div>
            ...
            <button className='bg-[#00D390] p-2 mt-2 rounded-md text-white'>Install Now ({size} MB)</button>
           </div>
        </div>    
       </div>
    );
