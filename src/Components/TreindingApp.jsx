  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-4 container mx-auto md:gap-12 ">
        {TreindingApp.map((data) => (
          <Card data={data} loading={loading} key={data.id}></Card>
        ))}
      </div>
      <div className="text-center my-10">
        <button className="p-2 px-3 text-white rounded-md  bg-gradient-to-r from-[#632EE3] to-[#9F62F2]">
          {" "}
